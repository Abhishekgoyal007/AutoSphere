...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'AutoSphere Dealership',
    "address" TEXT NOT NULL DEFAULT '123 Main St, City, Country',
    "phone" TEXT NOT NULL DEFAULT '+1 234 567 890',
    "email" TEXT NOT NULL DEFAULT 'dealership-email@example.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
