  ...
  useEffect(()=>{
    if (processImageResult?.success) {
      ...
      if (uploadedAiImage) {
        const reader = new FileReader();
        reader.onload = (e) => {
          setUploadingImages((prev) => [...prev, e.target.result]);
        };
        reader.readAsDataURL(uploadedAiImage);
      }

      toast.success("Car details extracted successfully from AI!", {
      ...
      <TabsList className="grid w-full grid-cols-2">
        ...
        <TabsContent value="ai" className="mt-6">
          ...
          <CardHeader>
            ...
            <CardDescription>
              Upload the images of the car and let our AI extract the details for you.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className='space-y-6'>
              <div>
                {imagePreview ? <div className='flex flex-col items-center justify-center'>
                  ...
                  <div {...getAiRootProps()} className='cursor-pointer hover:bg-gray-50 transition border-dashed border-2 border-gray-300 p-6 text-center rounded-lg'>
